  ...
  <div className="container">
    <div className='row mainImage'>
      <div className="col-xs-12 col-sm-4 mainFormWrapper">
        <div>
          <p>
            <b>Lorem ipsum</b> dolor sit amet, consectetur adipisicing elit. Temporibus voluptatibus at ratione numquam nam, maxime possimus earum illo nulla. Eius.
          </p>
          <form>
            <div className="form-group">
              <button className="btn btn-blue mainFormWrapper-btn">
                Empezar
              </button>
            </div>
          </form>
